...
import 'package:plot_twist/presentation/pages/discover/widgets/advanced_filters_sheet.dart';
...
void main() {
  ...
  group('AdvancedFiltersSheet Widget', () {
    Widget createTestWidget() {
      return ProviderScope(
        child: MaterialApp(
          theme: AppTheme.darkTheme,
          home: const Scaffold(body: AdvancedFiltersSheet()),
        ),
      );
    }
    ...
    testWidgets('should display media type selector in basic tab', (
      tester,
    ) async {
      await tester.pumpWidget(createTestWidget());
      await tester.pumpAndSettle();
    ...
    testWidgets('should switch between tabs', (tester) async {
      ...
      // Should show advanced filters content
    ...
    testWidgets('should close sheet when close button is tapped', (
      ...
      expect(find.byType(AdvancedFiltersSheet), findsOneWidget);

      // Close the sheet
      await tester.tap(find.byIcon(Icons.close_rounded));
      await tester.pumpAndSettle();

      expect(find.byType(AdvancedFiltersSheet), findsNothing);
    });
  });
